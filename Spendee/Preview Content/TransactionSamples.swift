...
extension Transaction {
    @MainActor static func makeSampleTransactions(in container: ModelContainer) {
        ...
        let transactions = [
            ...
            Transaction(title: "Monthly Salary", amount: 2800.00, icon: "creditcard.fill", date: Calendar.current.date(byAdding: .day, value: -25, to: Date())!, category: .salary, transactionType: .income),
